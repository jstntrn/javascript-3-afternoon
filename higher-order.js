...
let orderTotals = orders.map((element, index, array) => element.price * (1+element.tax));
...
*/
let bobArr = purchases.filter(own => own.owner === "Bob")

let bobsTotal = bobArr.reduce((acc, val) => {
